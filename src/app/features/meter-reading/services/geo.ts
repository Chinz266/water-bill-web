 ...
 * ⚠️ 10 ม. เป็นค่าที่เจ้าของระบบเลือก ไม่ใช่ค่าที่ข้อมูลชี้ (ข้อมูลชี้ 20 ม.) ป้ายยังผิดได้
 */
export const SIDE_TRUST_M = 10;
...
export function sideFloorFor(spreadA: number | null, spreadB: number | null): number {
  ...
  // ⚠️ พื้นกับเพดานเท่ากันที่ 10 ม. ฟังก์ชันจึงคืน 10 เสมอ — การปรับตามความแม่นรายคู่
