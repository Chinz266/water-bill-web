 ...
 * 2 คู่ (P06 และ P10) ที่หมุดห่างกันเกิน 15 ม. จนพ้นเขตสัญญาณรบกวน — และทิศที่ระบบตอบ
 * ทั้งชุดถูกเพียง 2 จาก 10 คู่ ซึ่งไม่ต่างจากการเดาสุ่ม เลข 10 เดิมเป็นค่าที่เลือกเอง
