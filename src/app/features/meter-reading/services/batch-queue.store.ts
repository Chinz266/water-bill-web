...
export interface StoredRow {
  seq: number;
  /**
   * รหัสประจำการจดของแถวนี้ — ต้องรอดข้ามการกู้คิวไปด้วย
   *
   * ประโยชน์ทั้งหมดของมันคือ "ยิงซ้ำแล้วไม่ได้บิลใบที่สอง" ซึ่งเคสที่ต้องใช้จริง
   * คือคิวที่ค้างเพราะไฟดับ/เน็ตหลุดกลางคัน — ถ้าไม่เก็บลงเครื่องด้วย รหัสจะหายไป
   * พร้อมหน้าที่ปิด แล้วการกดออกบิลซ้ำหลังกู้คิวจะสร้างบิลใบที่สองได้เหมือนเดิม
   *
   * แถวที่เก็บไว้ก่อนมีฟิลด์นี้จะเป็น undefined — ฝั่งที่อ่านต้องเผื่อไว้
   */
  clientUuid?: string;
  fileName: string;
