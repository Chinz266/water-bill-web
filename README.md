...
| `/members/batch` | ลงทะเบียนหลายบ้านจากรูปที่ถ่ายมา (มี `canDeactivate` กันเดินออกกลางคิว) |
...
โหมดนี้ส่งรูป **เต็มใบ** ไปให้ AI หาหน้าปัดเองก่อนอ่าน จึงพลาดง่ายกว่าโหมดทีละหลังที่คนครอบกรอบให้
ใบไหนอ่านไม่ออกหรืออ่านมาไม่มั่นใจ (< 85%) กด **"ครอปเฉพาะช่องตัวเลขแล้วอ่านใหม่"** ในแถวนั้นได้
ระบบจะส่งเฉพาะกรอบที่ครอปกลับไปอ่านใหม่ **แล้วจับคู่บ้านให้ใหม่ตามเลขที่ได้ด้วย**
(บ้านที่เสนอมาตอนแรกคิดจากเลขตัวเก่า ถ้าไม่คิดใหม่จะได้เลขถูกแต่บิลออกผิดบ้าน)
