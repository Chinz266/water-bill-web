...
**ห้ามใช้ `navigator.geolocation` ทุกกรณี** — ทั้งแอปไม่มีการเรียกเหลืออยู่แล้ว เครื่องที่ไม่มี GPS จริง (คอมที่ใช้พัฒนา/ทำงานอยู่ที่ทำการ หรือมือถือที่ปิดตำแหน่ง) เดาจากเน็ตแล้วคืนพิกัดที่ห่างมิเตอร์จริงเป็นร้อยกิโล ค่าพวกนี้เคยถูกบันทึกทับจนจับคู่รูปผิดบ้าน
